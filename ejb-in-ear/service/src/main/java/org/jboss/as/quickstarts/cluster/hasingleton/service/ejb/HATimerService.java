...
public class HATimerService implements Service<Environment> {
    ...
    public void start(StartContext context) throws StartException {
        ...
        try {
            ...
            ((Scheduler) ic.lookup("global/wildfly-ejb-in-ear-ear/wildfly-ejb-in-ear-ejb/SchedulerBean!org.jboss.as.quickstarts.cluster.hasingleton.service.ejb.Scheduler")).initialize("HASingleton timer @" + this.env.getValue().getNodeName() + " " + new Date());
    ...
    public void stop(StopContext context) {
        if (!started.compareAndSet(true, false)) {
            ...
            try {
                InitialContext ic = new InitialContext();
                ((Scheduler) ic.lookup("global/wildfly-ejb-in-ear-ear/wildfly-ejb-in-ear-ejb/SchedulerBean!org.jboss.as.quickstarts.cluster.hasingleton.service.ejb.Scheduler")).stop();
            } catch (NamingException e) {
